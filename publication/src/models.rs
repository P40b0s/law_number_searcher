...
#[serde(rename_all="camelCase")]
pub struct PublicationDocumentCardList
{
...
impl From<Bytes> for PublicationDocumentCardList
{
    fn from(value: Bytes) -> Self 
    {
        serde_json::from_slice(&value).unwrap()
...
{
    pub id: String,
    pub document_type: PublicationDocumentType,
...
#[derive(Deserialize, Debug)]
#[serde(rename_all="camelCase")]
pub struct PublicationDocumentType
{
    pub id: String,
...
impl From<Bytes> for PublicationDocumentType
{
    fn from(value: Bytes) -> Self 
    {
        serde_json::from_slice(&value).unwrap()
